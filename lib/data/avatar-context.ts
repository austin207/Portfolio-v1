...
## Key Projects
- 32-Bit Tiny GPU: 32-bit SIMT GPU built from scratch in SystemVerilog, designed solo from ISA to silicon. True SIMT branch divergence with warp-stack reconvergence, AXEL assembler, axelcc C-subset compiler, MMIO matmul accelerator, Q8 fixed-point neural nets up to a 64-16-10 classifier. 391 cocotb tests across 15 module suites. Signoff-clean GDSII on SkyWater Sky130A via OpenLane 2.3.10: 300,884 cells, 7.97 mm2 die, 0 Magic DRC, LVS matches uniquely at 188,812 devices, ~32.9 MHz post-route TT. Also targets the Sipeed Tang Nano 20K FPGA. GitHub: austin207/32-bit-Tiny-GPU
