  ...
  const certificates: Certificate[] = [
    {
      ...
      description: "Comprehensive foundational understanding of AWS Cloud concepts, core services, security best practices, architecture principles, pricing models, and support resources for cloud computing solutions.",
      credentialId: "AWS-CCP-2025-001",
      verificationUrl: "https://aws.amazon.com/verification",
      image: "/certificates/aws-cloud-practitioner.png",
      skills: ["AWS", "Cloud Computing", "Cloud Architecture", "Security", "Infrastructure"],
      status: "Active",
      category: "Cloud",
    },
    {
      ...
      issuer: "Google AI",
      date: "February 2025",
      description: "Intensive program covering machine learning fundamentals, TensorFlow framework, neural networks, model training, data preprocessing, and practical ML application development with real-world projects.",
      credentialId: "GOOGLE-ML-2025-002",
      verificationUrl: "https://developers.google.com/certificate",
      image: "/certificates/google-ml.png",
      skills: ["Machine Learning", "TensorFlow", "Python", "Data Science", "Neural Networks"],
      status: "Active",
      category: "AI/ML",
    },
    {
      ...
      issuer: "Meta",
      date: "January 2025",
      description: "Advanced React development focusing on modern patterns, custom hooks, context optimization, performance tuning, concurrent features, and scalable application architecture design.",
      ...
      skills: ["React", "JavaScript", "Frontend Development", "Performance", "TypeScript"],
      status: "Active",
    ...
    },
    {
      ...
      skills: ["Azure", "Cloud Services", "Microsoft", "Infrastructure", "Security"],
      status: "Active",
      category: "Cloud",
    },
    {
      ...
      date: "November 2024",
      description: "Professional-level container orchestration, Docker containerization, Kubernetes cluster management, microservices deployment, and container security best practices.",
      ...
      skills: ["Docker", "Kubernetes", "DevOps", "Container Orchestration", "Microservices"],
      status: "Active",
      category: "DevOps",
    },
    {
